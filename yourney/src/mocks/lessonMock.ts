...
export const mockLessons: Lesson[] = [
  ...
  },
  {
    ...
    students: [
      ...
      { id: 'S-111', firstName: 'Antoni', lastName: 'Kowalczyk', attendance: null },
      { id: 'S-112', firstName: 'Julia', lastName: 'Kamińska', attendance: null },
      { id: 'S-113', firstName: 'Filip', lastName: 'Lewandowski', attendance: null },
      { id: 'S-114', firstName: 'Hanna', lastName: 'Zielińska', attendance: null },
      { id: 'S-115', firstName: 'Szymon', lastName: 'Szymański', attendance: null },
      { id: 'S-116', firstName: 'Alicja', lastName: 'Dąbrowska', attendance: null },
    ],
  },
  {
    id: 'L-003',
